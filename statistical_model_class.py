...
nba_data['Predicted_Salary'] = nba_data['2P']*new_model.params[0] + nba_data['AST']*new_model.params[1] + nba_data['BLK']*new_model.params[2]
nba_data['Predicted_Salary']
nba_data['Salary_Residual'] = nba_data['salary_float'] - nba_data['Predicted_Salary']
